$(document).ready(function(){
	...
	//productCat() is a funtion fetching category record from database whenever page is load
	function productCat(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
			data	:	{productsCategory:1},
			success	:	function(data){
	...
	//deal() is a funtion fetching deal record from database whenever page is load
	function deal(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	//sliderRight() is a funtion fetching slider right content record from database whenever page is load
	function sliderRight(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
			data	:	{sliderRightContent:1},
			success	:	function(data){
				$("#slider_right_content").html(data);
	...
	*/
	...
	$("body").delegate(".productview","click",function(event){
		// $("#get_product").html("<h3>Loading...</h3>");
		event.preventDefault();
		var vid = $(this).attr('vid');
			...
			url		:	"action.php",
			method	:	"POST",
			data	:	{get_seleted_product:1,v_id:vid},
			success	:	function(data){
				$("#get_product").html(data);
				if($("body").width() < 880){
					$("body").scrollTop(683);
